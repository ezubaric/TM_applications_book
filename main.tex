...
\begin{abstract}
  ...
  sifting through an organization's e-mail, understanding a decade
  ...
  documents but to understand the general themes and ``topics''
  ...
  political texts.  In addition to these success stories, this survey
  also reviews the technical innovations that understanding these
  diverse types of documents requires in information retrieval,
  visualization, statistical inference, multilingual modeling, and

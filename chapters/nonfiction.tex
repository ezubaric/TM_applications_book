...
\jbgcomment{I don't think we've define close reading.  It might be worthwhile to add something in the intro if you'd like (and backpoint) or we should add more here.}
...
\jbgcomment{I don't like inline URLs; we should agree on a convention.  Footnotes?}
...
\jbgcomment{Need more text to provide a roadmap for the rest of the chapter}

...
\abr{lsa} embeds word types and documents in a low-dimensional space well, but the individual dimensions of this space are not interpretable as themes.
...
There is a large increase in discussions of \underline{Politics} in the period immediately around the American Revolution ({\em state government constitution law united power}).
There is also evidence of economic factors: a topic relating to descriptions of \underline{Cloth} ({\em silk cotton ditto white black linen}) rises in the 1750s, but then declines as Americans turned to domestic ``homespun'' cloth production in response to British trade policies.
...
Many factors that affect the quality of digitized historical newspapers, from the quality of the original printing to scanning, article segmentation, and optical character recognition (\abr{ocr}).

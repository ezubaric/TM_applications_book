...
\index{online latent Dirichlet allocation}
...
\index{distributed representation} Increasingly, vector-based,
...
The effect of representation learning on topic modeling remains
...
applied in representation learning.  This mollifies some
...
simple averaging do not seem worth the hassle~\citep{iyyer-15}.
...
Topic models have never been ideal, for example, in inducing features for text classification: it is almost always better to use word-count features.
...
However, in cases where interpretability and recognition are the main and final goals of analysis, deep learning methods offer little because their very advantage ---greater representational complexity---is also their weakness.
...
we use metadata?  Nor are the modeling choices needed to make sense

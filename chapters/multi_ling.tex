...
After manually identifying one  \underline{epistemology} topic from each language's model, these two topics are used as a form of query expansion to identify documents related to the target subject.

...
\jbgcomment{This introduction needs to be improved.  I think you
  should start with how many datasets are multilingual, then discuss
  how topic models help in this case, and then give an overview of the
  chapter. \yhcomment{fixed.}}
...
\jbgcomment{Give example of linked documents and where they come from.
  Stress that they don't have to be translations. \yhcomment{fixed.}}
...
\jbgcomment{Would be good to give the basic intution of what an LM
  is. \yhcomment{added.}}

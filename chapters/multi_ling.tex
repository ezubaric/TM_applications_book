...
\index{statistical machine translation}
...
\index{polylingual latent Dirichlet allocation}
...
\index{tree-based latent Dirichlet allocation}
\index{WordNet}
For instance, tree-based topic models such as tree-based latent Dirichlet 
allocation~\citep[\abr{tlda}]{boyd-graber-07,andrzejewski-09}
...
\index{Dirichlet distribution!tree}
...
\index{polylingual tree-based Latent Dirichlet allocation}
\index{dictionary}
\index{parallel corpus}
...
\index{statistical machine translation!domain adaptation}
...
\index{decoding (machine translation)}
...
\index{phrase (machine translation)}
...
\index{language model!machine translation}
...
\index{hidden topic Markov model}
\citet{Yu-2013} present a hidden topic Markov model~(\textsc{htmm}) to improve
...
\index{reordering (machine translation)}
...
\index{Bilingual topical admixture}

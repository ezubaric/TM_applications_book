...
sentiment.  This can come in the form a hard-coded distribution~\citep{mei-07}, a prior learned from observed
...
the generative model.  For example, both \citet{zhai-04} and
\citet{paul-10} develop topic models that allow readers to compare
...
\begin{figure}[ht]
    \includegraphics[width=0.5\textwidth]{figures/ideology_topics_vert}
    \caption{
...
Democrat based on the versions of topics they discuss, extending the
non-predictive model of \citet{grimmer-09}.  For example,

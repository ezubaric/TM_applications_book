...
Combinations of Dirichlet-discrete distributions (Chapter~\ref{ch:intro})
...
already familiar with Torch~\citep{collobert-11} or Theano~\citep{theano}, it's relatively easy to use
...
the settings of the model.  \citet{wallach-09a} detail the somewhat complicated

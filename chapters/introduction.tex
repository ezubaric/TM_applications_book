...
=======
We note that \abr{lda} is closely related to its probabilistic precursor, \abr{plsa} \citep{hofmann-99},
which can be viewed as a special case of \abr{lda} in which the Dirichlet priors are uniform.
...
\subsection{What's so Great about Dirichlets?}
...
that $\theta$ is simply a multinomial parameters.  In practice, this

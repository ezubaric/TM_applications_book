...
gives you ``topics'', each of which is a ranking of all the distinct words in the e-mails by relevance to a topic. Taking the top five most relevant words in each topic results in collections of words that make sense together (Figure~\ref{tab:enron_topics}).
